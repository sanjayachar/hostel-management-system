package com.hostel.accommodation.common.aspect;

import com.hostel.accommodation.dto.AuditLogEvent;
import com.hostel.accommodation.kafka.AuditLogProducer;
...
public class LoggingAspect {
    ...
    private static final String SERVICE_NAME = "accommodation-service";

    private final AuditLogProducer auditLogProducer;

    @Around("execution(* com.hostel.accommodation.controller..*(..)) || " + "execution(* com.hostel.accommodation.service..*(..))")
