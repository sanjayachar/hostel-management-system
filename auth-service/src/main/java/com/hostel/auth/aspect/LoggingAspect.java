...
import com.hostel.auth.dto.AuditLogEvent;
import com.hostel.auth.kafka.AuditLogProducer;
...
public class LoggingAspect {
    ...
    private Actor currentActor() {
        ...
        if (authentication.getPrincipal() instanceof CustomUserDetails userDetails) {
            userId = userDetails.user().getUserId();
            username = userDetails.user().getUsername();
            role = userDetails.user().getRole().getRoleName().name();
        }
